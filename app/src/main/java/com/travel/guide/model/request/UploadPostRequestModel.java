...
public class UploadPostRequestModel {
    ...
    public UploadPostRequestModel(List<Post_stories> post_stories, List<Integer> tages_user_id, List<String> hashtags, int music_id, String latLng, String address, String address_name, String description, String title) {
