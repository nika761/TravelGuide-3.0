...
public class UserPostsFragment extends Fragment implements UserPostListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        userPostPresenter.getUserPosts(ACCESS_TOKEN_BEARER + HelperPref.getAccessToken(recyclerView.getContext()), new PostByUserRequest(HelperPref.getUserId(recyclerView.getContext())));
    }
