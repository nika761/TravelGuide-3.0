...
public interface ApiService {
    ...
    Call<ChangeLangResponseModel> changeLanguage(@Header("Authorization") String token,
                                             @Body ChangeLangRequestModel changeLangRequestModel);

    @Headers({"Accept: application/json"})
    @POST("upload_content")
    Call<UploadPostResponseModel> uploadPost(@Header("Authorization") String token,
                                              @Body UploadPostRequestModel uploadPostRequestModel);
