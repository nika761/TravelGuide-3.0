...
import com.example.travelguide.ui.profile.adapter.recycler.FollowingAdapter;
import com.example.travelguide.helper.HelperPref;
import com.example.travelguide.ui.profile.interfaces.IFollowingFragment;
import com.example.travelguide.ui.profile.presenter.FollowingFragmentPresenter;

import static com.example.travelguide.network.ApiEndPoint.ACCESS_TOKEN_BEARER;

public class UserFollowingFragment extends Fragment implements IFollowingFragment {
    private Context context;
    private FollowingFragmentPresenter followingFragmentPresenter;
    private RecyclerView recyclerView;
    private int userId;

    public UserFollowingFragment(int userId) {
        this.userId = userId;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        followingFragmentPresenter.getFollowing(ACCESS_TOKEN_BEARER + HelperPref.getCurrentAccessToken(context), new FollowingRequest(userId));
    }
