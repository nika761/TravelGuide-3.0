...
import com.example.travelguide.upload.adapter.pager.GalleryPagerAdapter;
import com.example.travelguide.upload.adapter.recycler.GalleryAdapterMin;
...
public class GalleryPickerActivity extends AppCompatActivity implements GalleryFragment.ItemCountChangeListener {
    ...
    private void setClickListeners() {
        nextBtn.setOnClickListener(v -> {
            Intent intent = new Intent(GalleryPickerActivity.this, UploadPostActivity.class);
