...
import com.example.travelguide.upload.presenter.UploadPostPresenter;
...
//            startUpload();
    ...
    private void startUpload() {
        uploadPostPresenter.uploadStory("Bearer" + " " + HelperPref.getCurrentAccessToken(this), uploadStoryRequestModel);
    }
