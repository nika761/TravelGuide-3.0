...
import static com.example.travelguide.helper.HelperClients.amazonS3Client;
...
//            Log.d(TAG, "uploadWithTransferUtility: ");
        ...
        return Observable.create(emitter -> {
            ...
            TransferObserver observer = HelperClients.transferUtility(context, amazonS3Client(context))
